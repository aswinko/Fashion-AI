      ...
      <Card className="max-w-5xl">
        <CardContent className="px-5 py-4">
          <h3 className="pb-4 text-base font-semibold flex flex-wrap items-center gap-x-2">
            <span className="">Plan Summary</span>
          ...
          <div className="grid grid-cols-8 gap-4">
            <div className="col-span-5 flex flex-col pr-12">
              <div className="flex-1 text-xs font-sm flex w-full justify-between pb-1">
    ...
    <Card className="max-w-5xl">
      <CardContent className="px-5 py-4 pb-8">
        <h3 className="pb-4 text-base font-semibold flex flex-wrap items-center gap-x-2">
          <span className="">Plan Summary</span>
          <Badge variant="secondary" className="bg-primary/10">
            {subscriptionProducts?.name} Plans
          </Badge>
        </h3>
        <div className="grid grid-cols-8 gap-4">
          <div className="col-span-5 flex flex-col pr-12">
            <div className="flex-1 text-xs font-sm flex w-full justify-between items-center">
